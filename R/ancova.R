...
plot(DVpre  ~ IV, data=dfAnc, main="Prae-Scores pro Gruppe")
plot(DVpost ~ IV, data=dfAnc, main="Post-Scores pro Gruppe")
...
plot(DVpost ~ DVpre, data=dfAnc, xlim=xLims, ylim=yLims,
     ...
     main="Rohdaten und Regressionsgerade pro Gruppe", cex.lab=1.4)
