...
<!--
           | IV B - $1$ | ... | IV B - $k$ | ... | IV B - $Q$ |
-----------------------------------------------------------------------
IV A - $1$ | $\mu_{11}$ |     | $\mu_{1k}$ |     | $\mu_{1Q}$ | $\mu_{1.}$
           | $n_{11}$   | ... | $n_{1k}$   | ... | & $n_{1Q}$ | $n_{1+}$
--------------------------------------------------------------------------
...        | ...        | ... | ...        | ... | ...        | ...
--------------------------------------------------------------------------
IV A - $j$ | $\mu_{j1}$ |     | $\mu_{jk}$ |     | $\mu_{jQ}$ | $\mu_{j.}$
           | $n_{j1}$   | ... | $n_{jk}$   | ... | $n_{jQ}$   | $n_{j+}$
--------------------------------------------------------------------------
...        | ...        | ... | ...        | ... | ...        | ...
--------------------------------------------------------------------------
IV A - $P$ | $\mu_{P1}$ |     | $\mu_{Pk}$ |     | $\mu_{PQ}$ | $\mu_{P.}$
           | $n_{P1}$   | ... | $n_{Pk}$   | ... | $n_{PQ}$   | $n_{P+}$
--------------------------------------------------------------------------
           | $\mu_{.1}$ |     | $\mu_{.k}$ |     | $\mu_{.Q}$ |
           | $n_{+1}$   | ... | $n_{+k}$   | ... | $n_{+Q}$   |
-->
