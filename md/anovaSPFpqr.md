...
Die folgenden Quadratsummen tauchen aufgrund der Nesting-Struktur
mit id nicht im Ergebnis von lm() auf und muessen deshalb aus einem
Modell ohne id extrahiert werden
